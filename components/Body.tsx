      ...
      <div className="flex flex-col max-w-[320px] lg:max-w-[1440px] mx-auto lg:grid lg:grid-cols-4 lg:grid-flow-row gap-12 ">
        {flagData.map((flagdata, index) => (
          <div
            ...
            key={index}
            className="card cursor-pointer bg-white shadow-md rounded-lg"
          >
            <div className="image ">
              <Image
            ...
            <div className="description text-left ml-12 mb-6">
              <p className="font-bold my-4">{flagdata.name}</p>
              <p>
                <span>Population: </span>
                <span className="font-light">{flagdata.population}</span>
              </p>
              <p>
                <span>Region: </span>
                <span className="font-light">{flagdata.region}</span>
              </p>
              <p>
                <span>Capital: </span>
                <span className="font-light">{flagdata.capital}</span>
              </p>
            </div>
          </div>
        ))}
